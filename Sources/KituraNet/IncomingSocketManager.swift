...
public class IncomingSocketManager  {
    ...
    public func handle(socket: Socket, processor: IncomingSocketProcessor) {
        ...
        Log.debug("calling removeIdleSockets")
        removeIdleSockets()
        Log.debug("end handle socket")
    }
